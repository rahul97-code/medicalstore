...
public class AdminSettings extends JDialog {
	...
	public static void main(String[] args) {
		try {
			AdminSettings dialog = new AdminSettings("sukhpal");
	 ...
	 * Create the dialog.
	 */
	public AdminSettings(final String adminID) {
		setTitle("Change Password");
		setIconImage(Toolkit.getDefaultToolkit().getImage(AdminSettings.class.getResource("/icons/rotaryLogo.png")));
		...
		ResultSet rs=db.retrievePassword(adminID);
		try {
			while (rs.next()) {
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						}else
						{
							AdminDBConnection db=new AdminDBConnection();
							try {
								db.updateDataPassword(adminID, newPass);
							} catch (Exception e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
								db.closeConnection();
