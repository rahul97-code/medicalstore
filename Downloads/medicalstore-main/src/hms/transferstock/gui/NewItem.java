...
//		doctorcb.setSelectedIndex(0);
		...
		chckbxIsActive_1 = new JCheckBox("");
		...
		chckbxIsActive_1.setBounds(127, 413, 28, 25);
		panel_7.add(chckbxIsActive_1);
		
		JLabel lblExpiryDate_1 = new JLabel("Batch Reqd :");
		lblExpiryDate_1.setFont(new Font("Dialog", Font.PLAIN, 13));
		lblExpiryDate_1.setBounds(31, 415, 115, 20);
		panel_7.add(lblExpiryDate_1);
		getSupplierName();
		getDoctorName();
...
//	}
	public void getDoctorName() {
		...
		TransferDBConnection dbConnection = new TransferDBConnection();
	...
	public void getSupplierName() {
		...
		TransferDBConnection suppliersDBConnection = new TransferDBConnection();
