...
public class medicalstoreSaleSummery {
    ...
    private static void addHeader(Document document) throws DocumentException {
        Paragraph header = new Paragraph("MedicalStore Sale Report Daily Wise", FONT_HELVETICA_11_BOLD);
    ...
    private static void addItemsNotSoldTable(Document document, String fromDate, String toDate) throws DocumentException, SQLException {
        ...
        table.addCell(new PdfPCell(new Phrase("Total Billing Amount", FONT_HELVETICA_10_BOLD)));
        table.addCell(new PdfPCell(new Phrase("Total Cancel Bill Amount", FONT_HELVETICA_10_BOLD)));
        table.addCell(new PdfPCell(new Phrase("Total Sale Bill Amount", FONT_HELVETICA_10_BOLD)));
  

        try  {
        	BillingDBConnection con= new BillingDBConnection();
            ResultSet resultSet = con.MedicalStoreSaleSummery(fromDate, toDate);
