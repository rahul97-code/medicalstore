...
import hms.report.excel.ActiveItemsReportExcel;
...
public class ActiveItemsStatusReport extends JDialog {
	...
	public static void main(String[] arg) {
		new ActiveItemsStatusReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public ActiveItemsStatusReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ActiveItemsStatusReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(ActiveItemsStatusReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1(String dateFrom,String dateTo)
	{
		...
		try {
			...
			ResultSet rs = db.retrieveItemsStatus(dateFrom, dateTo);
			rsMain=rs;
