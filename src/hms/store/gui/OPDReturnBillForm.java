...
public class OPDReturnBillForm extends JDialog {
	...
	public static void main(String[] arg) {
		new OPDReturnBillForm().setVisible(true);
	}

	/**
	 * Create the dialog.
	 */
	public OPDReturnBillForm() {
		setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		setTitle("OPD Cancel Billing Form");

		setIconImage(Toolkit.getDefaultToolkit().getImage(
				OPDReturnBillForm.class.getResource("/icons/rotaryLogo.png")));
		setResizable(false);
		...
		lblNewLabel.setIcon(new ImageIcon(OPDReturnBillForm.class
		...
		JLabel lblBillCancellation = new JLabel("OPD Bill Return");
	...
	public void BillNo(String billNo) {
		...
		try {
			...
			ResultSet rs = db.retrieveBillDataDetail(billNo);
			while (rs.next()) {
