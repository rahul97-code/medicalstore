...
public class SalesItemReport extends JDialog {
	...
	public static void main(String[] arg) {
		new SalesItemReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public SalesItemReport() {
		setResizable(false);
		setTitle("Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(SalesItemReport.class.getResource("/icons/rotaryLogo.png")));
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(SalesItemReport.this) == JFileChooser.APPROVE_OPTION) {
