...
public class MedicalStoreIPDPdf {
	...
	public  MedicalStoreIPDPdf(String billno) throws DocumentException, IOException {
		...
		document.add(createBarCode(wr,billno));
