...
public class InsuranceGLPayments extends JDialog {
	...
	public static void main(String[] args) {
		try {
			InsuranceGLPayments dialog = new InsuranceGLPayments();
	 ...
	 * Create the dialog.
	 */
	public InsuranceGLPayments() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(InsuranceGLPayments.class.getResource("/icons/rotaryLogo.png")));
		setResizable(false);
		...
		insuranceCB.setBounds(170, 11, 218, 25);
		contentPanel.add(insuranceCB);
		insuranceCB.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				try {
					insuranceDisplaySTR = insuranceCB.getSelectedItem().toString();
				} catch (Exception e) {
...
//			        orderPayments.setVisible(true);
		...
		btnNewButton.setIcon(new ImageIcon(InsuranceGLPayments.class.getResource("/icons/1BL.PNG")));
		btnNewButton.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					new ExcelFile("Insurance Payments", table);
				} catch (Exception e2) {
					// TODO: handle exception
				}
		...
		lblNewLabel.setIcon(new ImageIcon(InsuranceGLPayments.class.getResource("/icons/list_dialog.png")));
	...
	public void populateExpensesTable(String dateFrom,String dateTo) {
		...
		try {
			...
			ResultSet rs = db.retrieveAllGLDetail(insuranceDisplaySTR, "INSURANCE", dateFromSTR, dateToSTR);
			...
			rs =  db.retrieveAllGLDetail(insuranceDisplaySTR, "INSURANCE", dateFromSTR, dateToSTR);
