...
public class ExcessStockReport extends JDialog {
	...
	public static void main(String[] arg) {
		new ExcessStockReport().setVisible(true);
	}
	/**
	 * Create the frame.
	 */
	public ExcessStockReport() {
		setResizable(false);
		setTitle("Excess Stock Report");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ExcessStockReport.class.getResource("/icons/rotaryLogo.png")));
		...
		scrollPane.setBounds(10, 64, 991, 365);
		...
		searchTF.setBounds(61, 25, 178, 28);
		...
		btnExcel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fileChooser.showSaveDialog(ExcessStockReport.this) == JFileChooser.APPROVE_OPTION) {
	...
	public void populateTable1()
	{
		...
		try {
           ...
           // System.out.println("Table: " + rs.getMetaData().getTableName(1));
            ...
            Logger.getLogger(ExcessStockReport.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
