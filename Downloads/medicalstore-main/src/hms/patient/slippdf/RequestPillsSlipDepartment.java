...
public class RequestPillsSlipDepartment {
    ...
    public static void main(String[] args) {
        try {
            RequestPillsSlipDepartment obj = new RequestPillsSlipDepartment();
            obj.readFile();
            ...
            pharmacyItems.itemBatchV.add("BatchA(01)");
            pharmacyItems.expiryDateV.add("2026-12-31");
            pharmacyItems.itemName.add("Ibuprofen");
            pharmacyItems.quantity.add("2");
            pharmacyItems.itemBatchV.add("BatchB(02)");
            pharmacyItems.expiryDateV.add("2027-06-30");
            ...
            radiologyItems.itemBatchV.add("BatchC(03)");
            radiologyItems.expiryDateV.add("2025-09-15");
            departmentData.put("Radiology", radiologyItems);

            // Now generate PDF dynamically
            obj.generateSlipForMultipleDepartments(departmentData, null,null);
     ...
     * @throws Exception
     */
    public void generateSlipForMultipleDepartments(Map<String, DepartmentItems> departmentData,
			Vector<String> reqInvoiceID, Vector<String> reqUserName) throws Exception {
        ...
        for (Map.Entry<String, DepartmentItems> entry : departmentData.entrySet()) {
            ...
            String index=reqInvoiceID.get(slipIndex);
            String returnedByName = reqUserName.get(slipIndex);
            addSlipToDocument(document, writer, entry.getKey(), items.itemName, items.quantity,
            		index, items.itemBatchV, items.expiryDateV, returnedByName);
            slipIndex++;
        }
        document.close();
    }
    ...
    public void addSlipToDocument(Document document, PdfWriter writer, String deptName,
        ...
        // *** Very important: NO page break here ***
    ...
    public static class DepartmentItems {
        ...
        public Vector<String> itemBatchV = new Vector<String>();
        public Vector<String> expiryDateV = new Vector<String>();
    }
